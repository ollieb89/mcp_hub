# ADR Generator Agent Process

This document describes the standardized process for creating Architectural Decision Records (ADRs) in this project.

---

## Overview

ADRs document important architectural and technical decisions with clear rationale, consequences, and alternatives. They serve as both historical record and decision-making guidance for the team.
...
See `adr-0000-template.md` in this directory for a complete example template.
...
2. Copy the template or follow the structure above
3. Fill in all required sections with meaningful content
4. Verify against the quality checklist
5. Save with proper naming: `adr-NNNN-decision-title.md`
